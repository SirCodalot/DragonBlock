package me.codalot.dragonblock.game.players.process.types;

import me.codalot.dragonblock.game.players.Fighter;
import me.codalot.dragonblock.game.players.components.Form;
import me.codalot.dragonblock.game.players.process.FighterProcess;
...
public class TransformationProcess extends FighterProcess {
    ...
    private void removeAura() {
        fighter.getModels().remove("aura");
    }

    private void setAura() {
        ItemStack aura = fighter.getAppearance().getAuraItem();
